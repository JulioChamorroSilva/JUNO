...
class SurvivalProbability_ME:
    ...
    def Pee( self, E, L):
        ...
        DelM2_31_ME = DelM2_ee_ME + (np.sin( Theta_12_ME )**2) * DelM2_21_ME #erro de runtime "invalid value encountered in sqrt
        DelM2_32_ME = DelM2_31_ME - DelM2_21_ME
        Delta21_ME = np.sqrt( DelM2_21_ME ) * L * UC.C**3 / (4 * E * UC.Hbar )
        Delta32_ME = np.sqrt(DelM2_32_ME) * L * UC.C**3 / (4 * E * UC.Hbar )
        Delta31_ME = np.sqrt(DelM2_31_ME) * L * UC.C**3 / (4 * E * UC.Hbar )
